      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-18 sm:h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <motion.div
            ...
            className="bg-white p-1.5 sm:p-2 rounded-xl shadow-sm border border-sky-200/40 flex items-center justify-center shrink-0"
          >
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="hidden sm:block text-[11px] text-slate-400 font-medium">
              Official Institutional Assessment Terminal
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-900/90 border border-sky-900/40 text-xs">
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
            <span className="text-slate-300 font-medium text-[11px]">System Live</span>
          </div>
