...
import { getSubmissionFileStorage, saveSubmissionFileStorage } from '../../../utils/fileStorage';
...
export const OsmWindow: React.FC<OsmWindowProps> = ({
  ...
  const handleFinishChecking = async () => {
    try {
      ...
      const sourceDocPayload = loadedPdfBytes || customPdfBase64 || submission.SubmissionUrl || '';
