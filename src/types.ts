...
export interface Exam {
  ...
  QuestionMarks?: { id: string; label: string; maxMarks: number }[]; // Question-wise marks configured for OSM
  SubmissionWindowMinutes?: number; // Teacher-configured submission grace period (max 10 mins)
}
